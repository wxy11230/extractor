...
implements IStepMeta {
    ...
    public MppStepMeta() {
        ...
        this.stepType = StepType.MPP_BASE;
        this.isConfig = false;
    }

    public MppStepMeta(String stepName) {
    ...
    public MppStepMeta(String stepName, String fileName) {
        this.stepName = stepName;
        this.stepGuid = StringUtil.getNextInternalId(s_nextId);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof MppStepMeta)) {
            return false;
        }
        MppStepMeta other = (MppStepMeta)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof MppStepMeta;
    }
